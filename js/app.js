...
(() => {
  ...
  function buildGrass() {
    ...
    grassKey = key;
    if (!tileTones) {
      // two of each tone, shuffled once per visit
      tileTones = ['white', 'silver', 'dark', 'white', 'silver', 'dark']
